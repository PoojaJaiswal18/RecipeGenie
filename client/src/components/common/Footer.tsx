      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-teal-400 font-bold text-xl tracking-tight">Recipe Genie</span>
            </Link>
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
            <div className="flex flex-col space-y-2">
              <h3 className="font-semibold text-teal-400">Navigation</h3>
            ...
            <div className="flex flex-col space-y-2">
              <h3 className="font-semibold text-teal-400">Account</h3>
              <Link to="/login" className="text-gray-300 hover:text-white text-sm">Login</Link>
              <Link to="/register" className="text-gray-300 hover:text-white text-sm">Sign Up</Link>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Recipe Genie. All rights reserved.
          </p>
